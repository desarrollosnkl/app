...
if(isset($_GET['id'])) {
    ...
    $nkl = $conexion -> prepare("SELECT * FROM horario WHERE id=:txtid");
...
$nkl = $conexion -> prepare("UPDATE horario SET dias=:dias,doctor=:doctor,fecha=:fecha WHERE id=:txtid");

$nkl -> bindParam(":dias",$dias);
...
<div id="login" >
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
              ...
              <label style="font-weight: bold;" for="dias" class="text-white">Dias medicas:</label>
               <input type="text" class="form-control" name="dias" value="<?php echo $dias; ?>" placeholder="ingrese su dia">
              </div>

              <div class="form-group">
              <label style="font-weight: bold;" for="doctor" class="text-white">Doctor:</label>
               <input type="text" class="form-control" name="doctor" value="<?php echo $doctor; ?>" placeholder="ingrese su dia">
              </div>
